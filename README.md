...
Study of Horizontal Worker Scaling using Celery — how adding more
workers increases task throughput in distributed task queue systems.
...
Task: T4 — Study Horizontal Worker Scaling
